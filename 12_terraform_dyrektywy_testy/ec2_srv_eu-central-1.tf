...
resource "aws_instance" "lekcja5_eu-central-1_ec2_srv" {
  ...
  ami                         = local.regional_amis["eu-central-1"]
  ...
  user_data                   = <<-EOF
    ...
    echo "<h1>Strona wdrozona przez user_data (Heredoc)!</h1><p>Frankfurt / eu-central-1</p>" > /var/www/html/index.nginx-debian.html
