...
resource "aws_instance" "lekcja5_ec2_srv" {
  ami                         = var.regional_amis["eu-north-1"]
...
lifecycle {
    ...
    precondition {
      ...
      error_message = "Niedozwolony typ instancji: ${var.instance_type}. Budzet projektu pozwala wylacznie na: t3.micro, t3.small, t2.micro, t2.small."
    }
  ...
  tags = merge(local.common_tags, {
    Name = "${local.name_prefix}-ec2-srv-sztokholm"
    Role = "WebServer"
  })  
